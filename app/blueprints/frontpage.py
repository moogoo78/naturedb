...
@frontpage.route('/guid/<path:record_key>', defaults={'lang_code': DEFAULT_LANG_CODE})
@frontpage.route('/<lang_code>/guid/<path:record_key>')
def guid_detail(record_key, lang_code):
