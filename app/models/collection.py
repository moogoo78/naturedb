    ...
    def get_items(payload, auth={}, mode=''):
        ...
        for r in rows:
            ...
            item.update({
                ...
                'longitude_decimal': float(longitude_decimal) if longitude_decimal is not None and not longitude_decimal.is_nan() else '',
                'latitude_decimal': float(latitude_decimal) if latitude_decimal is not None and not latitude_decimal.is_nan() else '',
