...
const ZH = {
  ...
  "Companion names": "隨同採集者",
  "Companion text": "隨同採集者",
  "Verbatim collect date": "採集日期（逐字）",
  "e.g., 412": "例：412",
  "Field number": "採集號",
  "Person": "人員",
  "Date": "日期",
  "Scientific name": "學名",
  "Verbatim identification": "學名（逐字）",
  "Locality text": "採集地點",
  "Verbatim locality": "採集地（逐字）",
  "Interpreted place name": "地名（解譯）",
  "Coordinates": "座標",
  "Administrative area": "行政區",
  "Altitude": "海拔",
  "Altitude 2": "海拔2",
  "Verbatim longitude": "x座標（逐字）",
  "Verbatim latitude": "y座標（逐字）",
  "Longitude DMS": "經度（度分秒）",
  "Latitude DMS": "緯度（度分秒）",
  "Longitude decimal": "經度（10進位）",
  "Latitude decimal": "緯度（10進位）",
  "Longitude": "經度",
  "Latitude": "緯度",
  "Country": "國家",
  "Admin area 1": "一級行政區",
