...
Revision ID: 7a60049f9f0f
Revises: 
Create Date: 2023-03-28 10:02:00.913497
...
def upgrade():
    ...
    sa.Column('other_name', sa.String(length=500), nullable=True),
    ...
    sa.Column('pub_status', sa.String(length=10), nullable=True),
